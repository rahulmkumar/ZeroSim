...
def tr(df_close,df_high,df_low):
...
# m*ATR(n)    
def atr(df_close,df_high,df_low,n,m):
...
def atrold(df_close,df_high,df_low,n):
...
def stochastic(df_close,df_high,df_low,n):
...
def macd(df_close,fast,slow,sig):
...
def keltner(df_close,df_high,df_low,e,a,m):
    sym_list = df_close.columns
    timestamps = df_close.index
...
def adx(df_close,df_high,df_low,n):
    sym_list = df_close.columns
    timestamps = df_close.index
...
def adxold(df_close,df_high,df_low,n):
    sym_list = df_close.columns
    timestamps = df_close.index
...
def ichimoku(df_close, df_high, df_low):
    '''
